            ...
            <div class="card-body p-0">
                ...
                <div class="pr-3 pl-3 pb-3">
                        <div style="height:100px">
                                ...
                                <p class="card-text mt-2">{{$item->content->order}}<a href="{{ route('contents.show', ['id' => $item->id]) }}" class="card-link">もっと詳しく</a></p>
                        ...
                        @if($item->content->helper_id == null)
                                ...
                                <td></td>
                        @elseif($item->content->helper_id == Auth::user()->id && $item->content->report_status == 3)
                                <td><form method="post" action="{{ route('mypage.tasks.update', ['id' => $item->content->id]) }}">@method('PATCH')@csrf<input class='btn btn-warning' type="submit" value="中断" ></form></td>
