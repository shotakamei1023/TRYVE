                ...
                <div class="pr-3 pl-3 pb-3">
                    <div style="height:100px">
                        ...
                        @elseif ($item->content_status == 4)
                                @if(isset($item->value))
                                        <div><button type="button" class="btn btn-info"><a href="{{ route('mypage.contents.review.show', ['id' => $item->id]) }}"><font color=white>評価したレポートを確認する</font></a></button></div>
                                @else
                                        <div>{{$item->helper->name}}さんからレポートが届きました</div>
                                        <div><button type="button" class="btn btn-primary"><a href="{{ route('mypage.contents.review.index', ['id' => $item->id]) }}"><font color=white>レポートを評価する</font></a></button></div>     
                                @endif 
                        @endif
                </div>
            </div>
