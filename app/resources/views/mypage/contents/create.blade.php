        ...
        <table class="table table-borderless">
          <tbody>
            <tr class="text-md-right row">
              ...
              <td class="col-xs-10 col-sm-6"><input class="form-control" type="text" name="title" value="{{old('title')}}" placeholder="〇〇の下見へ行ってください"></td>
            </tr>
            <tr class="text-md-right row">
              <td class="col-xs-10 col-sm-4"><label for="price" class="col-form-label">{{ __('相手に支払う金額を入力') }}</label></td>
              <td class="col-xs-10 col-sm-6"><input class="form-control" type="number" name="price" value="{{old('price')}}" placeholder="半角数字で数値のみの入力"></td>
            </tr>
            <tr class="text-md-right row">
              <td class="col-xs-10 col-sm-4"><label for="title" class="col-form-label">{{ __('相手にお願いする依頼の内容を入力') }}</label></td>
              <td class="col-xs-10 col-sm-6"><textarea class="form-control" rows="4" name="order" placeholder="東京駅中にある〇〇というお店でオムライスを食べ、美味しさをを教えてください">{{old('order')}}</textarea></td>
            </tr>
            <tr class="text-md-right row">
            ...
            <tr class="text-md-right row">
              ...
              <td class="col-xs-10 col-sm-6"><input class="form-control" id="prefectures" type="text" name="prefectures" value="{{old('prefectures')}}" placeholder="自動入力されます"></td>
            </tr>
            <tr class="text-md-right row">
              <td class="col-xs-10 col-sm-4"><label for="title" class="col-form-label">{{ __('都道府県以下') }}</label></td>
              <td class="col-xs-10 col-sm-6"><input class="form-control" id="address"　type="text" name="address" value="{{old('address')}}" placeholder="自動入力されます"></td>
            </tr>
          </tbody>
        </table>
...
<script src="{{ asset('/assets/js/googlemap_api.create.js') }}"></script>
